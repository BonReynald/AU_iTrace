    ...
    <div class="main-content">
        ...
        <div>
            ...
            <div class="top-bar justify-content-end">
                <button class="btn btn-primary" id="btnAddAdmin" data-toggle="modal" data-target="#createAdminModal">➕ Add Admin</button>
            </div>
    ...
    <div class="modal-content">
      <form method="POST" autocomplete="off" id="createAdminForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group"><label>Username</label><input type="text" name="username" class="form-control" autocomplete="off" required></div>
          <div class="form-group"><label>Email</label><input type="email" name="email" class="form-control" required></div>
          <div class="form-group"><label>Password</label><input type="password" name="password" class="form-control" autocomplete="new-password" required></div>
        </div>
...
<script>
// ✅ Reset Create Modal fields when button is clicked to prevent browser pre-fill
// This ensures that even if the browser forces data in, it is wiped when the modal opens
